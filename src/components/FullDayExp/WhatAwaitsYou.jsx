        ...
        <div className="relative overflow-hidden bg-[#0A2540] px-6 py-12 sm:px-10 sm:py-14 lg:px-16 lg:py-16">
          ...
          <div className="relative">
            <div className="flex items-center justify-center md:justify-center pt-8">
              <p className="font-heading text-3xl font-medium uppercase italic text-[#FFC93F] ml-0 md:ml-8 sm:text-5xl lg:text-5xl text-center" data-aos-anchor-placement="top-bottom" data-aos-duration="900">
                {heading}
              </p>
