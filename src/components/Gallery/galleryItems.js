...
const DEFS = [
  ...
  { name: "gallery29", category: "exterior", ratio: 1.7778, alt: "Aerial view of Superstar at anchor with the floating dock and jet skis, skyline beyond" },
  ...
  { name: "gallery30", category: "exterior", ratio: 1.7778, alt: "Aerial stern view of Superstar with guests boarding the floating dock beside jet skis" },
  ...
  { name: "gallery31", category: "exterior", ratio: 1.7778, alt: "Superstar at anchor with guests on the foredeck near a green shoreline" },
  ...
  { name: "gallery32", category: "exterior", ratio: 1.7778, alt: "Overhead view of guests lounging on the bow sunpads of Superstar" },
  ...
  { name: "gallery33", category: "exterior", ratio: 1.7778, alt: "Superstar anchored off the mangroves with guests on the floating dock and jet skis" },
  ...
  { name: "gallery34", category: "exterior", ratio: 1.7778, alt: "Stern view of Superstar at anchor with guests under the floating dock canopy" },
  ...
  { name: "gallery35", category: "exterior", ratio: 1.7778, alt: "Guests relaxing on the foredeck of Superstar anchored near shore" },
  ...
  { name: "gallery36", category: "exterior", ratio: 1.7778, alt: "Head-on view of Superstar at anchor with guests gathered on the bow" },
  { name: "gallery23", category: "exterior", ratio: 1.5000, alt: "Sporting clays shooting from the upper deck" },
  { name: "gallery37", category: "exterior", ratio: 1.7778, alt: "Guests lounging on the bow sunpads of Superstar with the coastline behind" },
